//In this assignment you are to add functionality to the calculator created in lab 08. You have to make the calculator a
...
public class JavaCalculator implements ActionListener {
   ...
   public static void main(String[] args) {
      ...
      panel1.add(button = new JButton ("1")); button.addActionListener(AL);
      panel1.add(button = new JButton ("2")); button.addActionListener(AL);
      panel1.add(button = new JButton ("3")); button.addActionListener(AL);
      ...
      panel3.add(button = new JButton ("7")); button.addActionListener(AL);
      panel3.add(button = new JButton ("8")); button.addActionListener(AL);
      panel3.add(button = new JButton ("9")); button.addActionListener(AL);
      panel3.add(button = new JButton ("*")); button.addActionListener(AL);
      contentPane.add(panel3);
      
      JPanel panel4 = new JPanel(new GridLayout(1,2,2,2)); 
      panel4.add(button = new JButton ("c")); button.addActionListener(AL);
      contentPane.add(panel4); 
      
      JPanel panel5 = new JPanel(new GridLayout(1,2,2,2));
      panel5.add(button = new JButton ("0")); button.addActionListener(AL);
